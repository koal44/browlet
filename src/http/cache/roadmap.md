...
The focused tests in `test/http/unit/` cover cache fields, freshness, and policy;
`date.test.ts` covers the shared HTTP-date dependency. Fixtures exercise the RFC's
