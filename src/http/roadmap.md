...
`npm run test:unit -- test/http` covers the HTTP modules. `test/http/unit/`
contains syntax/date/cache tests; Structured Fields retains its focused and
HTTPWG fixture tests under `test/http/struct-fields/`. The submodule roadmaps
