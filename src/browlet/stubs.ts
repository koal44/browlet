// These stubs add unfinished Web IDL surfaces to the type system only.
...
export const withShadowRootStub = stub<Omit<ShadowRoot, 'styleSheets' | 'adoptedStyleSheets'>>();
...
export const withHTMLLinkElementStub = stub<Omit<HTMLLinkElement, 'sheet'>>();
export const withHTMLStyleElementStub = stub<Omit<HTMLStyleElement, 'sheet'>>();
export const withHTMLUnknownElementStub = stub<HTMLUnknownElement>();
export const withSVGElementStub = stub<SVGElement>();
export const withSVGStyleElementStub = stub<Omit<SVGStyleElement, 'sheet'>>();
