...
| Section | Owner |
| --- | --- |
| §2.1.1 parallelism | `src/infra/parallel-queue.ts` for the cross-project serial queue; each consumer supplies host scheduling and retains its own algorithm state |
