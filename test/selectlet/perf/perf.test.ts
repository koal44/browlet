...
runPerfScenarios('perf', [
...

  {
    ...
    benches: [
      ...
      { op: 'select', selector: 'h1#title', ref: { by: 'document' }, iters: 20_000 },
      { op: 'select', selector: 'div.head h1#title', ref: { by: 'document' }, iters: 20_000 },

      // Class selectors
      { op: 'select', selector: 'dd.vcard > .fn', ref: { by: 'document' }, iters: 20_000 },
      { op: 'select', selector: '.vcard .url.fn', ref: { by: 'document' }, iters: 20_000 },
      { op: 'select', selector: '.nest.a1 .flatInNest.a6', ref: { by: 'document' }, iters: 20_000 },

      // Attribute selectors
      { op: 'select', selector: 'a.url.fn[lang="tr"]', ref: { by: 'document' }, iters: 20_000 },
      { op: 'select', selector: 'a[href^="http://www.w3.org/TR/"][href*="selectors"]', ref: { by: 'document' }, iters: 20_000 },
      { op: 'select', selector: 'a[href$=".html"]', ref: { by: 'document' }, iters: 20_000 },
      { op: 'select', selector: 'a[name="attribute-substrings"]', ref: { by: 'document' }, iters: 20_000 },
      { op: 'select', selector: 'a[href*="Consortium/Legal"]', ref: { by: 'document' }, iters: 20_000 },

      // Table / structural selectors
      { op: 'select', selector: 'table.selectorsReview tr > td.pattern', ref: { by: 'document' }, iters: 20_000 },
      { op: 'select', selector: 'li.tocline2 > a[href^="#"]', ref: { by: 'document' }, iters: 20_000 },
      { op: 'select', selector: 'li.tocline3 > ul.toc a[href="#universal-selector"]', ref: { by: 'document' }, iters: 20_000 },

      // :has()
      { op: 'select', selector: 'tr:has(> td.pattern)', ref: { by: 'document' }, iters: 20_000 },
      { op: 'select', selector: 'div.example:has(> pre)', ref: { by: 'document' }, iters: 20_000 },
      { op: 'select', selector: 'dd.vcard:has(a.url.fn[href^="mailto:"])', ref: { by: 'document' }, iters: 20_000 },
      { op: 'select', selector: 'h4:has(a[name="attribute-substrings"]) + p + dl dt code', ref: { by: 'document' }, iters: 20_000 },
      ...
      // Grouped selector lists / multiple arms
      { op: 'select', selector: 'h1#title, div.subtoc > h2, p.copyright', ref: { by: 'document' }, iters: 20_000 },
      { op: 'select', selector: 'td.pattern, td.meaning, td.origin', ref: { by: 'document' }, iters: 20_000 },
      { op: 'select', selector: 'div > b.flatOut.a1, div > i.flatOut.a2, div > b.flatOut.a3', ref: { by: 'document' }, iters: 20_000 },

      // Attribute selector orderin
      { op: 'select', selector: 'a[href$=".html"], a[href*="Consortium/Legal"], a[name="attribute-substrings"]', ref: { by: 'document' }, iters: 20_000 },
      { op: 'select', selector: 'a[href^="http://www.w3.org/TR/"], a[href$=".html"], a[href*="Consortium/Legal"]', ref: { by: 'document' }, iters: 20_000 },

      // Compound test ordering
      { op: 'select', selector: '[lang="tr"]:indeterminate', ref: { by: 'document' }, iters: 20_000 },
      { op: 'select', selector: ':indeterminate[lang="tr"]', ref: { by: 'document' }, iters: 20_000 },
    ],
  },

  {
    ...
    benches: [
      ...
      { op: 'first', selector: 'h1#title', ref: { by: 'document' }, iters: 20_000 },
      { op: 'first', selector: 'div.head h1#title', ref: { by: 'document' }, iters: 20_000 },

      { op: 'first', selector: 'dd.vcard > .fn', ref: { by: 'document' }, iters: 20_000 },
      { op: 'first', selector: '.vcard .url.fn', ref: { by: 'document' }, iters: 20_000 },
      { op: 'first', selector: '.nest.a1 .flatInNest.a6', ref: { by: 'document' }, iters: 20_000 },

      { op: 'first', selector: 'a.url.fn[lang="tr"]', ref: { by: 'document' }, iters: 20_000 },
      { op: 'first', selector: 'a[href^="http://www.w3.org/TR/"][href*="selectors"]', ref: { by: 'document' }, iters: 20_000 },
      { op: 'first', selector: 'a[href$=".html"]', ref: { by: 'document' }, iters: 20_000 },
      { op: 'first', selector: 'a[name="attribute-substrings"]', ref: { by: 'document' }, iters: 20_000 },
      { op: 'first', selector: 'a[href*="Consortium/Legal"]', ref: { by: 'document' }, iters: 20_000 },

      { op: 'first', selector: 'table.selectorsReview tr > td.pattern', ref: { by: 'document' }, iters: 20_000 },
      { op: 'first', selector: 'li.tocline2 > a[href^="#"]', ref: { by: 'document' }, iters: 20_000 },
      { op: 'first', selector: 'li.tocline3 > ul.toc a[href="#universal-selector"]', ref: { by: 'document' }, iters: 20_000 },

      { op: 'first', selector: 'tr:has(> td.pattern)', ref: { by: 'document' }, iters: 20_000 },
      { op: 'first', selector: 'div.example:has(> pre)', ref: { by: 'document' }, iters: 20_000 },
      { op: 'first', selector: 'dd.vcard:has(a.url.fn[href^="mailto:"])', ref: { by: 'document' }, iters: 20_000 },
      ...
      { op: 'first', selector: 'h1#title, div.subtoc > h2, p.copyright', ref: { by: 'document' }, iters: 20_000 },
      { op: 'first', selector: 'td.pattern, td.meaning, td.origin', ref: { by: 'document' }, iters: 20_000 },
      { op: 'first', selector: 'div > b.flatOut.a1, div > i.flatOut.a2, div > b.flatOut.a3', ref: { by: 'document' }, iters: 20_000 },

      // Attribute selector orderin
      { op: 'first', selector: 'a[href$=".html"], a[href*="Consortium/Legal"], a[name="attribute-substrings"]', ref: { by: 'document' }, iters: 20_000 },
      { op: 'first', selector: 'a[href^="http://www.w3.org/TR/"], a[href$=".html"], a[href*="Consortium/Legal"]', ref: { by: 'document' }, iters: 20_000 },
